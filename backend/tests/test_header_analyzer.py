"""Unit tests for HeaderAnalyzer — parsing correctness and signal emission."""
...
class TestAllAuthFail:
    def test_emits_three_signals(self, analyzer: HeaderAnalyzer):
        email = _make_email(
    ...
    def test_signal_ids(self, analyzer: HeaderAnalyzer):
        email = _make_email(
    ...
    def test_severities(self, analyzer: HeaderAnalyzer):
    ...
    def test_confidences_are_one(self, analyzer: HeaderAnalyzer):
        email = _make_email("mx.example.com; spf=fail; dkim=fail; dmarc=fail")
        output = analyzer.analyze(email)
...
class TestAllAuthPass:
    def test_no_signals(self, analyzer: HeaderAnalyzer):
        email = _make_email(
...
class TestMissingAuthHeader:
    def test_returns_blind_spot(self, analyzer: HeaderAnalyzer):
...
class TestMalformedAuthHeader:
    def test_garbage_produces_no_signals(self, analyzer: HeaderAnalyzer):
...
class TestPartialResults:
    def test_missing_method_is_not_failure(self, analyzer: HeaderAnalyzer):
...
class TestScoreContributionIsZero:
    def test_all_signals_have_zero_contribution(self, analyzer: HeaderAnalyzer):
        email = _make_email("mx.example.com; spf=fail; dkim=fail; dmarc=fail")
        output = analyzer.analyze(email)
...
class TestRealFixtures:
    def test_mass_phishing(self, analyzer: HeaderAnalyzer):
    ...
    def test_legit_amazon(self, analyzer: HeaderAnalyzer):
...
class TestCategoryIsAuthentication:
    def test_all_signals_tagged_correctly(self, analyzer: HeaderAnalyzer):
        email = _make_email("mx.example.com; spf=fail; dkim=fail; dmarc=fail")
        output = analyzer.analyze(email)
